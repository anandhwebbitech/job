                            ...
                            <div class="card-body">
                                ...
                                <div class="panel active" id="js-p1">
                                    ...
                                    <div class="frow">
                                        <div class="fgrp">
                                            ...
                                            <div class="ferr-msg" id="e-full_name"><i
                                        ...
                                        <div class="fgrp">
                                            ...
                                            <div class="ferr-msg" id="e-mobile"><i
                                    ...
                                    <div class="fgrp">
                                        ...
                                        <div class="ferr-msg" id="e-email"><i
                                    ...
                                    <div class="frow">
                                        <div class="fgrp">
                                            ...
                                            <div class="ferr-msg" id="e-password"><i
                                        ...
                                        <div class="fgrp">
                                            ...
                                            <div class="ferr-msg" id="e-confirm_password"><i
                                ...
                                <div class="panel" id="js-p2">
                                    ...
                                    <div class="frow3">
                                        <div class="fgrp">
                                            ...
                                            <div class="ferr-msg" id="e-state"><i
                                        ...
                                        <div class="fgrp">
                                            ...
                                            <div class="ferr-msg" id="e-district"><i
                                                    class="fa-solid fa-circle-exclamation"></i><span>Please select a
                                                    district.</span></div>
                                        </div>
                                        <div class="fgrp">
                                            ...
                                            <div class="ferr-msg" id="e-city"><i
                                ...
                                <div class="panel" id="js-p3">
                                    ...
                                    <div class="fgrp">
                                        ...
                                        <div class="ferr-msg" id="e-qualification"><i
                                        ...
                                        <div class="branch-card">
                                            ...
                                            <div class="frow">
                                                ...
                                                <div class="fgrp">
                                                    ...
                                                    <div class="fiw">
                                                        <i class="fa-solid fa-building fiw-l"></i>
                                                ...
                                                <div class="fgrp">
                                                    ...
                                                    <div class="fiw">
                                                        <i class="fa-solid fa-envelope fiw-l"></i>

                                                        <input type="email"
                                                            name="branch_email[]"
                                                            class="finput fc-g branch-email"
                                                            placeholder="branch@gmail.com"
                                                            oninput="validateGmail(this)">
                                                    </div>

                                                    <div class="ferr-msg email-error">
                                                        <i class="fa-solid fa-circle-exclamation"></i>
                                                        <span>Only Gmail address allowed.</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="frow">
                                                ...
                                                <div class="fgrp">
                                                    ...
                                                    <div class="fiw">
                                                        <i class="fa-solid fa-phone fiw-l"></i>

                                                         <input type="tel"
                                                            name="branch_mobile[]"
                                                            class="finput fc-g branch-mobile"
                                                            placeholder="9876543210"
                                                            maxlength="10"
                                                            oninput="validateBranchMobile(this)">
                                                    </div>
                                                    <div class="ferr-msg mobile-error">
                                                        <i class="fa-solid fa-circle-exclamation"></i>
                                                        <span>Enter valid 10 digit mobile number.</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="fgrp">
                                                    ...
                                                    <div class="fiw">
                                                        <i class="fa-solid fa-user-tie fiw-l"></i>
                                            ...
                                            <div class="fgrp">
                                                ...
                                                <div class="fiw">
                                                    <i class="fa-solid fa-location-dot fiw-l t"></i>
...
async function jsNav(dir) {

    if (dir === 1) {

        if (!jsValidate(jsStep)) return;
    ...
    if (jsStep === 5) {
        ...
        async function checkCompanyEmailExists(email) {
        ...
        async function empNav(dir) {

            if (dir === 1) {

                if (!empValidate(empStep)) return;
                ...
                if (empStep === 3) {
                    ...
                    if (email !== '') {
                        ...
                        let exists = await checkCompanyEmailExists(email);

                        console.log(exists);

                        if (exists) {

                            showError('c_email', 'Email already exists');
        ...
        function jsValidate(s) {
            ...
            if (s === 1) {
                ...
                if (password.length < 8) {
                    ...
                    showError('password', 'Password minimum 8 characters');
                    ok = false;
                }
            ...
            if (s === 3) {
                ...
                if (!qualification) {
                    ...
                    showError('qualification', 'Select qualification');
                    ok = false;
                }
            }
        ...
        function empValidate(step) {
            ...
            if (step === 1) {
                ...
                check('c_state', 'Please select state');

                check('c_district', 'Please select district');

                check('c_city', 'City is required');

                check('c_pincode', 'Pincode is required');

                let pin = document.getElementById('c_pincode').value;

                if (pin && !/^[0-9]{6}$/.test(pin)) {

                    showError('c_pincode', 'Enter valid 6 digit pincode');
            ...
            if (step === 2) {
                ...
                let mobile = document.getElementById('c_mobile').value.replace(/\D/g, '');

                if (mobile && mobile.length < 10) {

                    showError('c_mobile', 'Enter valid mobile number');

                    valid = false;
                }

                let hrmobile = document.getElementById('c_hr_mobile').value.replace(/\D/g, '');

                if (hrmobile && hrmobile.length < 10) {

                    showError('c_hr_mobile', 'Enter valid mobile number');
            ...
            if (step === 3) {
                ...
                check('c_confirm_password', 'Confirm password required');

                let email = document.getElementById('c_email').value;

                if (email && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email)) {

                    showError('c_email', 'Enter valid email');
                ...
                if (password && password.length < 8) {
                    ...
                    showError('c_password', 'Password minimum 8 characters');

                    valid = false;
                }

                let confirm = document.getElementById('c_confirm_password').value;

                if (password !== confirm) {

                    showError('c_confirm_password', 'Passwords do not match');
            ...
            if (step === 4) {
                ...
                check('c_gst', 'GST number required');

                let gst = document.getElementById('c_gst').value;

                if (gst && gst.length !== 15) {

                    showError('c_gst', 'GST must be 15 characters');
                ...
                if (docType) {
                    ...
                    check('add_doc_number', docType + ' number required');
                }
            }
            ...
            if (step === 5) {
                ...
                check('gst_certificate', 'GST certificate required');

                let docType = document.getElementById('add_doc_type').value;

                if (docType) {

                    check('add_doc_file', docType + ' file required');
                }
            }
        ...
        document.getElementById('employer_register').addEventListener('click', function(e) {
            ...
            .catch(error => {
                ...
                if (error.status === 422) {
                    ...
                    // toaster
                    if (firstMessage && typeof toastr !== 'undefined') {
    ...
    const errorBox = document.getElementById('e-' + fieldId);
...
function addBranch() {
    ...
    <div class="branch-card" style="margin-top:25px;">
...
function removeBranch(btn) {
    ...
    btn.closest('.branch-card').remove();
}
function validateGmail(input) {

    let value = input.value.trim();

    let errorBox = input.closest('.fgrp').querySelector('.email-error');
...
function validateBranchMobile(input) {
    ...
    let errorBox = input.closest('.fgrp').querySelector('.mobile-error');
