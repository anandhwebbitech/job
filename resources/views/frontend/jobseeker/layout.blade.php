{{-- ═══════════════════════════════════════════════════════
     ...
     QueueJobs – Job Seeker Dashboard Layout
...
<title>@yield('title', 'Dashboard') – QueueJobs</title>
...
<header class="lj-topbar">
  ...
  <a href="{{ route('home') }}" class="lj-topbar-brand">
    ...
    <span class="lj-brand-name"><img src="{{ asset('public/frontend/logo.png') }}" alt="Logo" style="max-height:50px;"></span>
  </a>
